...
import Banner from "../../assets/services/boston/chicagoBanner.avif";
import Chicago from "../../assets/services/boston/chicago.avif";
...
const ChicagoSeo = () => {
    ...
    const faqs = [
        {
            question: "What does a Chicago SEO agency do?",
            answer: "A Chicago SEO agency helps businesses improve their search engine rankings, increase organic traffic, and generate more leads through strategic website optimization.",
        },
        {
            question: "How long does SEO take to work?",
            answer: "SEO typically takes 3–6 months to start showing noticeable improvements depending on your industry competition and website condition.",
        },
        {
            question: "Why is local SEO important for Chicago businesses?",
        ...
        {
            question: "Can SEO help increase website conversions?",
            answer: "Yes. By attracting targeted traffic and improving user experience, SEO helps convert visitors into leads and customers.",
        },
        {
            question: "Do you optimize websites for mobile search?",
            answer: "Yes. Mobile optimization is a key ranking factor, and we ensure your website performs well across all devices.",
        },
        {
            question: "What industries benefit from Chicago SEO services?",
            answer: "SEO benefits many industries including healthcare, legal services, real estate, ecommerce, hospitality, and local service businesses.",
        },
        {
            question: "How do you measure SEO campaign success?",
            answer: "SEO success is measured through keyword rankings, organic traffic growth, engagement metrics, and lead conversions.",
        },
    ];
    ...
    const stats = [
        {
            ...
            value: "+228%",
            title: "Increase in Organic Search Traffic",
            desc: "Average growth achieved for Chicago clients.",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            value: "+342%",
            title: "Increase in Qualified Web Leads",
            desc: "Direct result of strong Chicago-focused SEO strategies.",
        },
    ];
    ...
    const benefits = [
        {
            icon: <FaSearch size={28} />,
            title: "Capture High-Intent Chicago Searchers",
            desc: "Appear when local customers are actively looking for your services.",
        },
        {
            icon: <FaUsers size={28} />,
            title: "Drive Targeted Local Traffic",
            desc: "Attract Chicago visitors ready to contact or visit your business.",
        },
        {
            icon: <FaMapMarkedAlt arkerAlt size={28} />,
            title: "Dominate Chicago 'Near Me' Searches",
        ...
        },
        {
            ...
            desc: "Top rankings make your Chicago business appear more credible.",
        },
        {
            icon: <FaCalendarAlt size={28} />,
            title: "Capture Seasonal & Event Traffic",
            desc: "Rank for Chicago-specific trends, festivals, sports events, and seasons.",
        },
        {
            icon: <FaBullseye size={28} />,
            title: "Compete with Bigger Players",
            desc: "Local + niche SEO helps Chicago businesses outrank national brands.",
        },
        {
            icon: <FaChartLine size={28} />,
            title: "Improve Lead Quality & Conversions",
            desc: "Optimized pages turn organic Chicago visitors into high-quality leads.",
        },
    ];
    ...
    const services = [
        {
            ...
            desc: "In-depth keyword analysis to identify high-value terms for your Chicago business — competitor strategies, search intent, market demand.",
        },
        {
            icon: <FaLink size={28} />,
            title: "Authority Link Building",
            desc: "White-hat link-building to secure high-quality backlinks from relevant sites, boosting domain authority and Chicago search rankings.",
        },
        {
            icon: <FaPenNib size={28} />,
            title: "SEO Content Strategy",
            desc: "Engaging, SEO-optimized content — blogs, landing pages, service pages — that attracts visitors and supports long-term organic growth.",
        },
        {
            icon: <FaCogs size={28} />,
            title: "On-Site SEO Optimization",
            desc: "Optimize meta titles, descriptions, headers, internal linking, keyword placement — better crawlability and user experience.",
        },
        {
            icon: <FaMapMarkerAlt size={28} />,
            title: "Local SEO for Chicago Businesses",
            desc: "Google Business Profile, local citations, reviews, geo-targeted keywords — dominate Chicago-area search results.",
        },
        {
            icon: <FaServer size={28} />,
            title: "Technical SEO Improvements",
            desc: "Site speed, mobile responsiveness, crawlability, indexing, structured data — technically sound foundation for strong rankings.",
        },
        {
            icon: <FaShoppingCart size={28} />,
            title: "Ecommerce SEO Solutions",
            desc: "Product page optimization, schema markup, site navigation — increase traffic and online sales for Chicago ecommerce brands.",
        },
        {
            icon: <FaMicrophone size={28} />,
            title: "Voice Search Optimization",
            desc: "Conversational queries and long-tail keywords — capture voice-driven traffic from smart devices in the Chicago market.",
        },
    ];
    ...
    const features = [
        {
            ...
            desc: "Full-spectrum optimization — keyword research, technical SEO, content, link building — everything your site needs to perform.",
        },
        {
            icon: <FaCity size={28} />,
            title: "Chicago Market Expertise",
            desc: "Deep understanding of Chicago’s competitive landscape and local search behavior.",
        },
        {
            icon: <FaBullseye size={28} />,
            title: "Results-Driven SEO Strategies",
            desc: "Every campaign built around measurable outcomes — traffic, rankings, leads.",
        },
        {
            icon: <FaUserTie size={28} />,
            title: "Experienced SEO Professionals",
            desc: "Team stays current with algorithm updates and best practices for sustained performance.",
        },
        {
            icon: <FaLightbulb size={28} />,
            title: "Customized Optimization Plans",
            desc: "Tailored strategies matching your industry, goals, competition, and Chicago audience.",
        },
        {
            icon: <FaChartPie size={28} />,
            title: "Clear Reporting and Communication",
            desc: "Detailed reports and regular updates — full transparency on your SEO progress.",
        },
    ];
    ...
    return (
        <div ref={rootRef} className="bg-white text-black">
            ...
            >
                ...
                >
                    <h1 className="text-5xl md:text-6xl font-extrabold">Chicago SEO</h1>
                    <p className="mt-6 text-lg text-gray-300">
                        Accelerate Business Growth with Chicago SEO Experts
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-md md:text-xl font-semibold mt-5 text-[#020202]">
                            Dominate Chicago Search Results
                        </h2>
                        <p className="text-black mt-4">
                            Our Chicago SEO agency helps local businesses, ecommerce brands, and service providers generate more qualified leads by optimizing their digital presence for search engines, AI-powered platforms, and local search results.
                        </p>
                    </div>
                ...
                <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <h2 className="text-3xl md:text-4xl font-extrabold text-black mb-6">
                            Trusted Chicago SEO Partner for{" "}
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            In a competitive market like Chicago, businesses need a strong digital strategy to stand out online.
                            <br /><br />
                            Our Chicago SEO company delivers customized optimization strategies designed to increase website traffic, improve search engine rankings, and generate consistent leads.
                            <br /><br />
                            Our team focuses on delivering measurable growth through data-driven SEO campaigns tailored to your industry, audience, and business goals.
                        </p>
                    </div>
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            Why <span className="text-[#25baff]">Chicago SEO</span> Delivers Real Results
                        </h2>
                        <p className="text-gray-300 max-w-3xl mx-auto text-lg leading-relaxed">
                            Drive Traffic and Leads with Proven SEO Strategies tailored for the Chicago market.
                        </p>
                    </motion.div>
                    ...
                    >
                        <div>
                            ...
                            <ul className="space-y-4 text-gray-300">
                                ...
                                <li>• On-Site SEO Optimization</li>
                        ...
                        <div className="bg-gradient-to-br from-[#25baff]/10 to-[#a8d97c]/10 p-8 rounded-2xl border border-white/10 backdrop-blur-lg">
                            <p className="text-lg leading-relaxed text-gray-200">
                                We don’t chase vanity metrics — we build visibility that turns Chicago searches into real leads, calls, form submissions, and customers.
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#020202] mb-4">
                            Turn Chicago Searches Into{" "}
                            <span className="text-[#25baff]">Leads & Revenue</span>
                        </h2>
                        <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                            Strategic Chicago SEO helps you capture customers at every stage — from awareness to conversion.
                        </p>
                    </motion.div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto text-center">
                    ...
                    <div className="mb-16">
                        ...
                        <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
                            Choose the Strategy That Builds Long-Term Growth for Your Chicago Business
                        </p>
                        ...
                        <div className="group bg-white/10 backdrop-blur-xl border-2 border-[#25baff] rounded-2xl shadow-2xl shadow-[#25baff]/30 hover:-translate-y-4 transition-all duration-500 flex flex-col justify-between relative">
                            ...
                            <div>
                                ...
                                <div className="text-gray-300 space-y-3 px-6 py-6">
                                    ...
                                    <p>Highly targeted by service & Chicago location</p>
            ...
            >
                ...
                <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                    <h2 className="gsap-item text-white text-3xl font-extrabold max-w-4xl">
                        Talk To Our Chicago SEO Experts Now
                    </h2>
            ...
            <section className="bg-[#a8d97c] py-28">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-[#020202] mb-3">
                        Chicago SEO Strategies We Execute

                    </h2>

                    <p className="font-semibold text-gray-600 mb-3 px-6">
                        We help Chicago businesses grow through targeted, high-conversion SEO strategies tailored to local visibility and fierce market competition.
                    </p>
                </div>
                        ...
                        {[
                            {
                                ...
                                head1: "Find What Chicago Searches",
                                text: "In-depth analysis uncovering high-value, intent-driven keywords specific to your Chicago audience.",
                            },
                            {
                                icon: FaLink,
                                head: "Authority Link Building",
                                head1: "Build Real Domain Power",
                                text: "White-hat outreach securing quality backlinks from relevant Chicago-relevant and industry sites.",
                            },
                            {
                                icon: FiPenTool,
                                head: "SEO Content Strategy",
                                head1: "Content That Ranks & Converts",
                                text: "SEO-optimized blogs, service pages, and landing content crafted for Chicago searchers.",
                            },
                            {
                                icon: IoSettingsSharp,
                                head: "On-Site SEO Optimization",
                                head1: "Perfect On-Page Foundation",
                                text: "Meta tags, headers, internal links, keyword placement — maximum crawl & user experience.",
                            },
                            {
                                icon: FaMapMarkerAlt,
                                head: "Local SEO for Chicago",
                                head1: "Own the Chicago Map Pack",
                                text: "GBP optimization, citations, reviews, geo-landing pages — dominate local Chicago search.",
                            },
                            {
                                icon: FaLightbulb,
            ...
            <section className="py-24 px-6 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#020202] mb-4">
                            Our <span className="text-[#25baff]">Chicago SEO</span> Services
                        </h2>
                        <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                            Complete, performance-focused SEO solutions built to increase visibility, traffic, leads, and revenue for Chicago businesses.
                        </p>
                    </motion.div>
            ...
            <section className="bg-white py-28">
                <div className="text-center mb-16">
                    ...
                    <p className="font-semibold text-gray-500 mb-3 pt-5 px-12">
                        Structured, results-oriented process tailored for Chicago businesses — from deep audit to sustained local dominance.
                        <br />Here’s how we build long-term visibility and leads in Chicago:
                    </p>
                </div>
                        ...
                        {[
                            {
                                ...
                                text: "Deep technical audit, Chicago competitor analysis, keyword mapping, custom growth roadmap.",
                            },
                            {
                            ...
                            },
                            {
                                ...
                                text: "Google Business mastery, citation building, review strategy, Chicago geo-targeted pages.",
                            },
                            {
                                head: "Content Creation & Publishing",
                                text: "High-value blogs, guides, service pages, FAQs — built for Chicago search intent.",
                            },
                            {
                                head: "Authority & Link Building",
                                text: "Strategic outreach to Chicago media, blogs, directories — quality backlinks that move the needle.",
                            },
                            {
                ...
                <div className="relative max-w-6xl mx-auto text-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                            Why Chicago Businesses Trust Our{" "}
                            <span className="text-[#a8d97c]">SEO Expertise</span>
                        </h2>
                        <p className="text-gray-300 max-w-3xl mx-auto text-lg">
                            We combine Chicago market knowledge with technical precision, local focus, and conversion-first strategies to deliver measurable revenue growth.
                        </p>
                    </motion.div>
