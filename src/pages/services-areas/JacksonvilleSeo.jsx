...
import Banner from "../../assets/services/boston/jacksonvilleBanner.avif";
import Jacksonville from "../../assets/services/boston/jacksonville.avif";

gsap.registerPlugin(ScrollTrigger);

const JacksonvilleSeo = () => {
    ...
    const faqs = [
        {
            question: "How long does SEO take to show results in Jacksonville?",
            answer:
                "Most businesses start seeing noticeable SEO improvements within 3–6 months, depending on competition and website authority.",
        },
        {
            question: "Why is local SEO important for Jacksonville businesses?",
            answer:
                "Local SEO helps businesses appear in Google Maps and local search results, attracting nearby customers actively searching for services.",
        },
        {
            question: "How much do Jacksonville SEO services cost?",
            answer:
                "SEO pricing depends on your business goals, competition, and project scope. We offer flexible and affordable SEO packages.",
        },
        {
            question: "Can SEO increase leads for my business?",
            answer:
                "Yes. SEO brings high-intent organic traffic, increasing inquiries, calls, and conversions.",
        },
        {
            question: "Do you provide monthly SEO reports?",
            answer:
                "Yes. We provide transparent monthly reports showing keyword rankings, traffic growth, and campaign performance.",
        },
        {
            question: "Which industries benefit from Jacksonville SEO services?",
            answer:
                "Industries like healthcare, legal services, real estate, home services, and eCommerce benefit greatly from SEO.",
        },
        {
            question: "Why choose Digital Webguider for Jacksonville SEO?",
            answer:
                "Digital Webguider combines data-driven SEO strategies, AI-powered optimization, and transparent reporting to help Jacksonville businesses grow online.",
        },
    ];
    ...
    const stats = [
        {
            ...
            desc: "Average growth achieved for Jacksonville clients.",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            desc: "Direct result of strong Jacksonville-focused SEO strategies.",
        },
    ];
    ...
    const benefits = [
        {
            icon: <FaSearch size={28} />,
            title: "Capture High-Intent Jacksonville Searchers",
            desc: "Appear when local customers are actively looking for your services.",
        },
        {
            icon: <FaUsers size={28} />,
            title: "Drive Targeted Local Traffic",
            desc: "Attract Jacksonville visitors ready to contact or visit your business.",
        },
        {
            icon: <FaMapMarkedAlt size={28} />,
            title: "Dominate Jacksonville 'Near Me' Searches",
        ...
        },
        {
            ...
            desc: "Top rankings make your Jacksonville business appear more credible.",
        },
        {
            icon: <FaCalendarAlt size={28} />,
            title: "Capture Seasonal & Event Traffic",
            desc: "Rank for Jacksonville-specific trends, festivals, sports events, and seasons.",
        },
        {
            icon: <FaBullseye size={28} />,
            title: "Compete with Bigger Players",
            desc: "Local + niche SEO helps Jacksonville businesses outrank national brands.",
        },
        {
            icon: <FaChartLine size={28} />,
            title: "Improve Lead Quality & Conversions",
            desc: "Optimized pages turn organic Jacksonville visitors into high-quality leads.",
        },
    ];
    ...
    const services = [
        {
            ...
            desc: "Our Jacksonville SEO experts identify high-value keywords that your target audience actively searches for — monthly search volume, keyword difficulty and competitiveness, search intent and relevance, local Jacksonville search trends.",
        },
        {
            icon: <FaPenNib size={28} />,
            title: "Content Marketing",
            desc: "Our team develops high-quality, engaging content aligned with user intent and search engine algorithms — SEO blog articles, landing page content, website optimization, social media content, local SEO content.",
        },
        {
            icon: <FaCogs size={28} />,
            title: "On-Page Optimization",
            desc: "Keyword-optimized meta titles and descriptions, SEO-friendly URL structures, content and heading optimization, image and alt-tag optimization, internal linking improvements, page speed enhancements, mobile responsiveness.",
        },
        {
            icon: <FaServer size={28} />,
            title: "Link Building",
            desc: "White-hat techniques — guest posting on authoritative websites, outreach campaigns, content-based backlink strategies, internal linking optimization.",
        },
        {
            icon: <FaMapMarkerAlt size={28} />,
            title: "Technical SEO",
            desc: "Website speed optimization, mobile-friendly design improvements, secure HTTPS implementation, XML sitemap optimization, crawl error fixes, structured data schema implementation.",
        },
        {
            icon: <FaShoppingCart size={28} />,
            title: "Local SEO",
            desc: "Local keyword targeting, Google Business Profile optimization, local citations and directory listings, review management strategies, location-based landing pages.",
        },
        {
    ...
    const features = [
        {
            ...
            desc: "Our Jacksonville SEO team studies your audience’s behavior, demographics, and interests to create targeted strategies that reach the right customers at the right time.",
        },
        {
            icon: <FaCity size={28} />,
            title: "Analytical Research & Strategy",
            desc: "We develop SEO strategies using detailed keyword research, competitor analysis, and website performance insights to maximize search visibility and improve rankings.",
        },
        {
            icon: <FaBullseye size={28} />,
            title: "SEO Expertise",
            desc: "Our Jacksonville SEO experts use advanced on-page, technical, and off-page SEO techniques to help businesses achieve higher rankings and attract qualified traffic.",
        },
        {
            icon: <FaUserTie size={28} />,
            title: "Strategic Implementation",
            desc: "After identifying optimization opportunities, our team develops a clear SEO roadmap that includes technical improvements, content marketing strategies, and backlink development.",
        },
        {
            icon: <FaLightbulb size={28} />,
            title: "Results-Driven SEO Process",
            desc: "Comprehensive website audits, competitor analysis, keyword research, site structure improvements, content marketing, link-building strategies, ongoing SEO reporting.",
        },
        {
            icon: <FaChartPie size={28} />,
            title: "Analytics & Reporting",
            desc: "Website traffic analysis, keyword ranking improvements, lead and conversion tracking, bounce rate insights, top performing pages, user behavior data.",
        },
    ];
        ...
        <div ref={rootRef} className="bg-white text-black">
            ...
            >
                ...
                <div ref={heroRef} className="relative z-10 text-center px-6 text-white">
                    <h1 className="text-5xl md:text-6xl font-extrabold">Jacksonville SEO</h1>
                    <p className="mt-6 text-lg text-gray-300">
                        Full-Service Jacksonville SEO Company
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-extrabold text-[#020202]">
                            Jacksonville <span className="text-[#25baff]">SEO Services</span>
                        </h2>
                        <h2 className="text-md md:text-xl font-semibold mt-5 text-[#020202]">
                            Dominate Jacksonville Search Results
                        </h2>
                        <p className="text-black mt-4">
                            Get discovered across the First Coast with our advanced Jacksonville SEO and digital marketing services. We help businesses attract high-intent customers, increase online visibility, generate qualified leads, and boost local sales through data-driven SEO strategies.
                            Our Jacksonville SEO solutions combine local SEO, content marketing, technical optimization, and AI-powered search strategies to ensure your business stands out in a competitive digital landscape.
                        </p>
                    </div>
                ...
                <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl md:text-4xl font-extrabold text-black mb-6">
                            About Our <span className="text-[#25baff]">Jacksonville SEO Company</span>
                        </h2>
                        <p className="text-gray-700 leading-relaxed">
                            Digital Webguider helps businesses in Jacksonville grow through strategic SEO, PPC advertising, social media marketing, and professional web design services.
                            <br /><br />
                            Our Jacksonville SEO specialists implement proven strategies such as on-page SEO optimization, high-quality link building, strategic content marketing, local search optimization, technical SEO improvements.
                            <br /><br />
                            Our goal is not just improving search rankings. We focus on driving high-quality organic traffic, increasing engagement, and improving conversion rates so your business achieves sustainable growth and strong return on investment.
                            <br /><br />
                            Businesses trust Digital Webguider as a reliable Jacksonville SEO agency that delivers measurable digital marketing success.
                        </p>
                    </div>
            ...
            {/* ================= DARK SECTION - WHY JACKSONVILLE SEO ================= */}
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            Why <span className="text-[#25baff]">Jacksonville SEO</span> Delivers Real Results
                        </h2>
                        <p className="text-gray-300 max-w-3xl mx-auto text-lg leading-relaxed">
                            Drive Traffic and Leads with Proven SEO Strategies tailored for the Jacksonville market.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="bg-gradient-to-br from-[#25baff]/10 to-[#a8d97c]/10 p-8 rounded-2xl border border-white/10 backdrop-blur-lg">
                            <p className="text-lg leading-relaxed text-gray-200">
                                We don’t chase vanity metrics — we build visibility that turns Jacksonville searches into real leads, calls, form submissions, and customers.
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#020202] mb-4">
                            Turn Jacksonville Searches Into{" "}
                            <span className="text-[#25baff]">Leads & Revenue</span>
                        </h2>
                        <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                            Strategic Jacksonville SEO helps you capture customers at every stage — from awareness to conversion.
                        </p>
                    </motion.div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto text-center">
                    <div className="mb-16">
                        <h2 className="text-4xl md:text-5xl font-extrabold text-white">
                            Jacksonville SEO vs. <span className="text-[#25baff]">Paid Advertising</span>
                        </h2>
                        <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
                            Choose the Strategy That Builds Long-Term Growth for Your Jacksonville Business
                        </p>
                    </div>
                        ...
                        <div className="group bg-white/10 backdrop-blur-xl border-2 border-[#25baff] rounded-2xl shadow-2xl shadow-[#25baff]/30 hover:-translate-y-4 transition-all duration-500 flex flex-col justify-between relative">
                            <div>
                                ...
                                <div className="text-gray-300 space-y-3 px-6 py-6">
                                    ...
                                    <p>Highly targeted by service & Jacksonville location</p>
            ...
            >
                ...
                <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                    <h2 className="gsap-item text-white text-3xl font-extrabold max-w-4xl">
                        Talk To Our Jacksonville SEO Experts Now
                    </h2>
            ...
            <section className="bg-[#a8d97c] py-28">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-[#020202] mb-3">
                        Jacksonville SEO Strategies We Execute
                    </h2>

                    <p className="font-semibold text-gray-600 mb-3 px-6">
                        We help Jacksonville businesses grow through targeted, high-conversion SEO strategies tailored to local visibility and fierce market competition.
                    </p>
                </div>
                        ...
                        {[
                            {
                                ...
                                head1: "Find What Jacksonville Searches",
                                text: "High-value, intent-driven, local and long-tail keywords specific to your Jacksonville audience.",
                            },
                            {
                                icon: FaLink,
                                head: "High-Quality Link Building",
                                head1: "Build Real Domain Power",
                                text: "White-hat outreach securing authoritative backlinks from relevant sites.",
                            },
                            {
                                icon: FiPenTool,
                                head: "Content Marketing",
                                head1: "Content That Ranks & Converts",
                                text: "SEO-optimized blogs, landing pages, and local content crafted for Jacksonville searchers.",
                            },
                            {
                            ...
                            {
                                icon: FaMapMarkerAlt,
                                head: "Local SEO for Jacksonville",
                                head1: "Own the Jacksonville Map Pack",
                                text: "GBP optimization, citations, reviews, geo-landing pages — dominate local search.",
                            },
                            {
                                icon: FaLightbulb,
                                head: "Technical & AI SEO",
                                head1: "Future-Proof Your Visibility",
                                text: "Speed, mobile, schema, crawlability + AI-powered search optimization.",
                            },
                        ].map((item, index) => {
            ...
            <section className="py-24 px-6 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-[#020202] mb-4">
                            Our <span className="text-[#25baff]">Jacksonville SEO</span> Services
                        </h2>
                        <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                            Achieve sustainable search engine success with our expert SEO team and AI-driven strategies.
                        </p>
                    </motion.div>
            ...
            <section className="bg-white py-28">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-[#020202] mb-3">
                        Our Proven Jacksonville
                        <span className="text-[#25baff]"> SEO Framework</span>
                    </h2>
                    <p className="font-semibold text-gray-500 mb-3 pt-5 px-12">
                        Structured, results-oriented process tailored for Jacksonville businesses — from deep audit to sustained local dominance.
                        <br />Here’s how we build long-term visibility and leads in Jacksonville:
                    </p>
                </div>
                        ...
                        {[
                            {
                                ...
                                text: "Deep technical audit, Jacksonville competitor analysis, keyword mapping, custom growth roadmap.",
                            },
                            {
                            ...
                            },
                            {
                                ...
                                text: "Google Business mastery, citation building, review strategy, Jacksonville geo-targeted pages.",
                            },
                            {
                                head: "Content Creation & Publishing",
                                text: "High-value blogs, guides, service pages, FAQs — built for Jacksonville search intent.",
                            },
                            {
                                head: "Authority & Link Building",
                                text: "Strategic outreach to Jacksonville media, blogs, directories — quality backlinks that move the needle.",
                            },
                            {
                ...
                <div className="relative max-w-6xl mx-auto text-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                            Why Jacksonville Businesses Trust Our{" "}
                            <span className="text-[#a8d97c]">SEO Expertise</span>
                        </h2>
                        <p className="text-gray-300 max-w-3xl mx-auto text-lg">
                            We combine Jacksonville market knowledge with technical precision, local focus, and conversion-first strategies to deliver measurable revenue growth.
                        </p>
                    </motion.div>
            ...
            <section ref={addSectionRef} className="bg-gray-50 py-28 px-6">
                <div className="max-w-5xl mx-auto">
                    <h2 className="gsap-item text-4xl font-extrabold text-[#020202] mb-12 text-center">
                        Jacksonville SEO Agency <span className="text-[#25baff]">FAQs</span>
                    </h2>
...
export default JacksonvilleSeo;