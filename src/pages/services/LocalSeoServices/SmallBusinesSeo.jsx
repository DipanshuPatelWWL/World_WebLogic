          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-black mt-4">
                Get more online traffic & more footfall with our affordable
                small business SEO services. Here’s how our small business SEO
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="text-[#020202]">
                <p className="mb-6">
                  ...
                  visibility on search engines to attract more customers and
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-14">
              ...
              <p className="mt-6 text-gray-600">
                ...
                visibility, attract the right audience, and convert visitors
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  We optimize your website to rank higher on Google and other
                  search engines, helping your business get discovered by
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  ...
                  we bring relevant visitors to your website who are more likely
                  to convert.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  ...
                  to ensure users enjoy a smooth browsing experience that
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  ...
                  making your brand more reliable in the eyes of potential
                  customers.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  Our local SEO techniques help your business appear in nearby
                  searches, driving more local inquiries and foot traffic.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  With optimized content and strategic SEO planning, we help
                  turn website visitors into paying customers, boosting your
                  revenue.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <p className="text-gray-600 mb-6">
                  Here’s why working with a professional SEO company can make a
                  big difference:
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-bold text-black">
                ...
                <span className="text-[#25baff]">
                  {" "}
                  Digital WebGuider for Your SEO Growth
                </span>
              </h2>
              <div className="w-30 h-1 bg-[#a8d97c] mx-auto mt-4 rounded-full"></div>
              <p className="mt-6 text-gray-600">
                Selecting the right SEO agency can define your business success
                online. At Digital WebGuider, we focus on performance-driven
                strategies, measurable growth, and long-term digital success for
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  Digital WebGuider offers flexible and cost-effective SEO
                  packages designed specifically for startups and small
                  businesses. Our goal is to maximize your ROI while keeping
                  your marketing investment efficient and result-oriented.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  We don’t rely on guesswork. Our SEO campaigns are built on
                  in-depth research, competitor analysis, and performance
                  tracking to ensure your business reaches the right audience at
                  the right time.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  Our certified professionals stay updated with the latest
                  Google algorithms and digital trends. We implement
                  industry-approved SEO practices that enhance your website
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  From local businesses to service-based companies, Digital
                  WebGuider has successfully handled diverse industry projects,
                  allowing us to craft customized strategies for every niche.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  We provide end-to-end services including on-page SEO,
                  technical optimization, content strategy, link building, and
                  performance monitoring — all under one roof.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md transition-all duration-300 ease-in-out border-1 border-transparent hover:-translate-y-3 hover:shadow-[0_20px_20px_rgba(37,186,255,0.35)] hover:border-[#25baff]">
                ...
                <p className="text-gray-600">
                  Transparency is at the core of our work. We provide detailed
                  monthly reports, keyword tracking insights, and ongoing
                  consultation so you stay informed about every improvement and
                  milestone.
                </p>
              </div>
            </div>
        ...
        <section className="bg-gray-50 py-16 px-6 md:px-16">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-14">
              ...
              <div className="w-30 h-1 bg-[#a8d97c] mx-auto mt-4 rounded-full"></div>
              <p className="mt-6 text-gray-600">
                At Digital WebGuider, we follow a structured and
                performance-focused SEO process to help small businesses build
                strong online visibility and achieve consistent growth. Our
                strategy is designed to deliver measurable and long-term
                results.
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <h2 className="gsap-item relative inline-block text-2xl md:text-3xl font-extrabold text-[#020202] mb-6">
                    Comprehensive{" "}
                    <span className="text-[#25baff]">SEO Website Audit</span>
                  ...
                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    Our process begins with a detailed website audit to identify
                    strengths, weaknesses, and growth opportunities. We analyze
                    technical structure, site speed, mobile responsiveness,
                    indexing issues, and overall user experience.
                    <br />
                    Using advanced SEO tools and industry best practices, the
                    Digital WebGuider team detects problems such as broken
                    links, duplicate content, crawl errors, and optimization
                    gaps. We also optimize robots.txt, sitemap structure, and
                    core technical elements to ensure search engines can
                    properly understand and rank your website.
                    <br />
                    This strong technical foundation allows your business to
                    compete effectively and achieve sustainable SEO success.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="py-15 px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    You’re not the only business competing for top search
                    rankings. Many small and medium-sized businesses are
                    targeting the same keywords and audience as you. That’s why
                    a detailed competitor analysis is essential for building a
                    strong SEO strategy.
                    <br />
                    At Digital WebGuider, we conduct in-depth competitor
                    research to understand what’s working in your industry and
                    where opportunities exist. Our team analyzes competitor
                    keywords, content strategies, backlink profiles, website
                    structure, and overall search performance.
                    <br />
                    By identifying their strengths and weaknesses, we create
                    smarter SEO campaigns that help you outperform competitors,
                    capture more organic traffic, and strengthen your online
                    visibility.
                  </p>
                </div>
            ...
            <section className="px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <h2 className="gsap-item relative inline-block text-2xl md:text-3xl font-extrabold text-[#020202] mb-6">
                    Strategic{" "}
                    <span className="text-[#25baff]">Keyword Planning</span>
                    <span className="absolute left-0 -bottom-2 w-20 h-1 bg-[#25baff] rounded-full"></span>
                  </h2>

                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    Effective SEO starts with selecting the right keywords that
                    match your business goals and customer intent. Without
                    proper keyword planning, even the best website may struggle
                    to rank.
                    <br />
                    At Digital WebGuider, we conduct detailed keyword research
                    using advanced SEO tools and industry data. We identify
                    high-impact, long-tail, and location-based keywords that
                    attract the right audience to your website.
                    <br />
                    Our team analyzes search intent, competition level, and
                    search trends to ensure your content targets keywords that
                    drive meaningful traffic — not just random visitors. By
                    focusing on relevant and conversion-focused keywords, we
                    help position your business in front of customers who are
                    actively searching for your services.
                    <br />
                    This strategic approach builds a strong foundation for
                    better rankings, increased visibility, and sustainable
                    online growth.
                  </p>
                </div>
              </div>
            ...
            <section className="py-15 px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <h2 className="gsap-item relative inline-block text-3xl md:text-4xl font-extrabold text-[#020202] mb-6">
                    On-Page SEO{" "}
                    <span className="text-[#25baff]">Enhancement</span>
                    <span className="absolute left-0 -bottom-2 w-20 h-1 bg-[#25baff] rounded-full"></span>
                  </h2>

                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    On-page optimization plays a crucial role in improving your
                    website’s search engine rankings and overall visibility. A
                    well-optimized website not only helps search engines
                    understand your content but also improves user experience.
                    <br />
                    Our on-page SEO process focuses on optimizing key elements
                    such as title tags, meta descriptions, header structure,
                    keyword placement, and internal linking. We ensure that
                    every page is strategically structured to target relevant
                    keywords while maintaining natural and engaging content.
                    <br />
                    We also optimize images with proper alt tags, improve URL
                    structure, enhance page speed, and implement structured data
                    to make your website more search-engine friendly.
                    Additionally, local SEO signals are integrated to strengthen
                    your presence in location-based searches.
                    <br />
                    This comprehensive approach ensures your website is
                    technically sound, content-rich, and fully optimized to
            ...
            <section className="px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    High-quality content is the foundation of successful SEO.
                    Without relevant and valuable content, it becomes difficult
                    to attract, engage, and convert your target audience.
                    <br />
                    Our content strategy begins with in-depth keyword planning
                    and audience research to understand what your potential
                    customers are searching for. We create well-structured,
                    SEO-optimized content that aligns with user intent while
                    maintaining clarity and readability.
                    <br />
                    Each piece of content is strategically crafted with proper
                    keyword placement, optimized headings, internal linking, and
                    structured formatting to improve search engine visibility.
                    We also implement schema markup and content hierarchy to
                    enhance rich results and strengthen topical authority.
                    <br />
                    By combining data-driven SEO strategies with engaging
                    storytelling, we help position your business as a trusted
                    authority while increasing organic traffic and long-term
                    growth.
                  </p>
                </div>
              </div>
            ...
            <section className="py-15 px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    A strong local presence is essential for small businesses
                    that want to attract nearby customers. Optimizing your
                    Google Business Profile ensures your company appears in
                    local search results, Google Maps, and “near me” searches.
                    <br />
                    We begin by properly setting up, verifying, and optimizing
                    your profile with accurate business information, relevant
                    keywords, service details, and high-quality images. This
                    helps search engines clearly understand your business and
                    improves your chances of appearing in the local pack.
                    <br />
                    Our strategy also includes review management, regular
                    updates, post creation, and local engagement signals to
                    build credibility and customer trust. By strengthening your
                    local SEO foundation, we help increase visibility, drive
                    more calls and inquiries, and convert local searches into
                    real customers.
                  </p>
                </div>
            ...
            <section className="px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <h2 className="gsap-item relative inline-block text-2xl md:text-3xl font-extrabold text-[#020202] mb-6">
                    Authority Building &{" "}
                    <span className="text-[#25baff]">Quality Backlinks</span>
                    <span className="absolute left-0 -bottom-2 w-20 h-1 bg-[#25baff] rounded-full"></span>
                  </h2>

                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    Building strong backlinks is essential for improving search
                    engine rankings and increasing domain authority. A
                    well-planned link-building strategy helps establish your
                    website as a credible and trusted source within your
                    industry.
                    <br />
                    Our approach focuses on acquiring high-quality, relevant
                    backlinks from authoritative websites. Through strategic
                    outreach, industry collaborations, guest contributions, and
                    content-driven campaigns, we create natural link
                    opportunities that strengthen your online presence.
                    <br />
                    We prioritize quality over quantity, ensuring every backlink
                    aligns with your niche and adds genuine value to your
                    website. This ethical and long-term strategy enhances search
                    engine trust, improves rankings, and positions your business
                    as a reliable authority in your market.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="py-15 px-6" ref={addSectionRef}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="gsap-item text-gray-600 leading-relaxed mb-6">
                    Measuring results is a critical part of any successful SEO
                    strategy. Without accurate tracking and reporting, it’s
                    impossible to understand what’s working and where
                    improvements are needed.
                    <br />
                    Our reporting process uses advanced analytics tools to
                    monitor keyword rankings, organic traffic growth, user
                    engagement, and conversion performance. We carefully analyze
                    important metrics such as click-through rates, bounce rates,
                    backlink quality, and overall search visibility.
                    <br />
                    Through detailed monthly reports and performance insights,
                    you gain a clear understanding of your campaign progress.
                    This data-driven approach allows for continuous
                    optimization, helping your business adapt to search engine
                    updates and market trends.
                    <br />
                    With transparent reporting and strategic analysis, we ensure
                    your SEO investment delivers measurable growth and long-term
                    online success.
                  </p>
                </div>
